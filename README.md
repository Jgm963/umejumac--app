    ...
    <header class="bg-venezuelan-primary text-white p-4 shadow-md sticky top-0 z-50">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <nav class="hidden md:flex space-x-6 text-lg">
                ...
                <a href="https://www.blogger.com/blog/posts/6500366606015502758" target="_blank" class="hover:text-venezuelan-secondary transition-colors duration-300">Blog</a>
            </nav>
            <!-- Mobile Menu -->
            <div class="md:hidden">
        ...
        <div id="mobile-menu" class="hidden md:hidden absolute top-16 right-4 bg-venezuelan-primary rounded-lg shadow-lg p-2 w-48 text-right">
            ...
            <a href="https://www.blogger.com/blog/posts/6500366606015502758" target="_blank" class="block py-2 hover:bg-venezuelan-secondary hover:text-gray-800 rounded">Blog</a>
        </div>
    </header>
