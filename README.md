    ...
    <script type="module">
        ...
        const deleteProduct = async () => {
            ...
            try {
                ...
                alert(`Fallo al eliminar: ${error.message}`); // Usamos un custom alert para manejar el error
            } finally {
        ...
        // CRÍTICO: Esta función inicia la app, resuelve el modo estático/dinámico y muestra la vista principal.
        const startApp = () => {
            initializeFirebase();
            showView('main');
        };
