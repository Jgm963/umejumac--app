...
<body class="bg-[#F7F7F7]">
    ...
    <main class="container mx-auto px-4 py-8 space-y-12">
        ...
        <section id="servicios" class="space-y-8">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <!-- Tarjeta de Bienes y Servicios (con la galería integrada) -->
                <div class="bg-yellow-400 text-blue-900 p-6 rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 transform hover:-translate-y-2">
                    ...
                    <!-- Sección de Galería dentro de Bienes y Servicios -->
                    <div id="galeria" class="mt-6 space-y-4">
                        <h5 class="text-2xl font-bold text-blue-900">Transacciones de bienes</h5>
                        <div id="galeria-fotos" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            <!-- Las fotos se insertarán aquí con JavaScript -->
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        const fotosDeVenta = [
            ...
            { nombreArchivo: 'IMG_20250421_163443.jpg', titulo: 'Libro de Derecho Mercantil' },
            { nombreArchivo: 'cc.png', titulo: 'Libro de Derecho Civil' },
            { nombreArchivo: 'tt.png', titulo: 'Manual de Contabilidad' },
            { nombreArchivo: 'vv.png', titulo: 'Guía de Asesoría Legal' },
            { nombreArchivo: 'zzz.png', titulo: 'Colección de Leyes' },
            { nombreArchivo: 'cv.png', titulo: 'Manual de Negocios' },
            { nombreArchivo: 'def.png', titulo: 'Libro de Finanzas' },
            { nombreArchivo: 'mmm.png', titulo: 'Código de Comercio' },
            { nombreArchivo: 'jjj.png', titulo: 'Compendio Jurídico' },
            { nombreArchivo: 'lll.png', titulo: 'Texto de Economía' },
            { nombreArchivo: 'kkk.png', titulo: 'Libro de Marketing' },
            { nombreArchivo: 'aaa.jpg', titulo: 'Análisis de Mercado' },
            { nombreArchivo: 'jjj.jpg', titulo: 'Estrategias de Venta' },
            { nombreArchivo: 'www.png', titulo: 'Exposición de Proyectos' },
            { nombreArchivo: 'tttt.jpg', titulo: 'Sesión de Venta' },
            { nombreArchivo: 'ooo.jpg', titulo: 'Liderazgo Empresarial' },
            { nombreArchivo: 'z.png', titulo: 'Enfoque Estratégico' },
            { nombreArchivo: 'x.png', titulo: 'Proyección de Crecimiento' },
            { nombreArchivo: 'q.png', titulo: 'Intercambio Comercial' },
            { nombreArchivo: 'd.png', titulo: 'Crecimiento Económico' },
