...
<head>
    ...
    <style>
        ...
        /* Logo en el encabezado: usa el logo-umejumac.png */
        .header-logo-display {
            width: 50px;
            height: 50px;
...
<body>
    ...
    <header class="header-umejumac">
        ...
        <a href="#about-logo" onclick="event.preventDefault(); scrollToLogo('about-logo');" class="logo-button" aria-label="Ver detalles del logo UMEJUMAC">
            <div class="header-logo-display">
                <img src="logo-umejumac.png" alt="Logo UMEJUMAC" title="Haga clic para ver el significado del logo">
            </div>
        </a>
    </header>
    ...
    <div class="container" id="home">
        ...
        <section id="about-logo">
            <h2 style="color: var(--color-principal);">Nuestro Sello Distintivo y Fundamento</h2>
            <div class="fabricated-logo-display">
                <img src="logo-umejumac.png" alt="Logo UMEJUMAC Detallado" class="logo-image-large">
            </div>
            <p>Este logo representa la **convergencia** de la gestión profesional de la Unidad Médico-Jurídica, bajo el liderazgo del Dr. Morales (identificado por las iniciales E.J.M.R.), y el compromiso con la **Alta Efectividad (ETA)** en cada consulta y proyecto. Es el símbolo de la unión de la experiencia médica y la base legal.</p>
        </section>
    ...
    <script>
        /**
         * Función para realizar un desplazamiento suave (smooth scroll) al elemento de destino.
