...
<main class="py-12">
    <div class="container mx-auto px-4">
        ...
        <section id="galeria" class="space-y-8 py-6">
            ...
            <p class="text-center text-lg text-gray-600">Aquí encontrará **publicaciones especializadas, instrumental, vehículos y otros activos** disponibles para su adquisición. Revise que los nombres de sus archivos subidos coincidan exactamente con la propiedad "src".</p>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-6">
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden transform transition-transform duration-300 hover:scale-105">
                    <!-- ASEGÚRESE DE QUE EL NOMBRE DEL ARCHIVO 'fff.png' ESTÉ SUBIDO Y SEA CORRECTO -->
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden transform transition-transform duration-300 hover:scale-105">
                    <!-- ASEGÚRESE DE QUE EL NOMBRE DEL ARCHIVO 'nnn.jpg' ESTÉ SUBIDO Y SEA CORRECTO -->
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden transform transition-transform duration-300 hover:scale-105">
                    <!-- ASEGÚRESE DE QUE EL NOMBRE DEL ARCHIVO 'ddd.png' ESTÉ SUBIDO Y SEA CORRECTO -->
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden transform transition-transform duration-300 hover:scale-105">
                    <!-- ASEGÚRESE DE QUE EL NOMBRE DEL ARCHIVO 'li8.png' ESTÉ SUBIDO Y SEA CORRECTO -->
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden transform transition-transform duration-300 hover:scale-105">
                    <!-- ASEGÚRESE DE QUE EL NOMBRE DEL ARCHIVO 'actuuu.png' ESTÉ SUBIDO Y SEA CORRECTO -->
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden transform transition-transform duration-300 hover:scale-105">
                    <!-- ASEGÚRESE DE QUE EL NOMBRE DEL ARCHIVO 'bb.png' ESTÉ SUBIDO Y SEA CORRECTO -->
