...
<head>
    ...
    <style>
        ...
        body {
            ...
            color: #333;
            /* PROPIEDAD CLAVE PARA EL DESPLAZAMIENTO SUAVE */
        ...
        #about-logo {
            ...
            margin-top: 40px;
            min-height: 400px; /* Asegura que la sección tenga suficiente altura */
        }
        ...
        /* --- ESPACIO ADICIONAL PARA PRUEBAS (SOLO EJEMPLO) --- */
        .spacer {
            height: 600px;
            display: flex;
            justify-content: center;
...
<body>
    ...
    <header class="header-umejumac">
        <h1>UMEJUMAC</h1>
        <a href="#about-logo" class="logo-button" aria-label="Ver detalles del logo UMEJUMAC">
    ...
    <div class="container" id="home">
        ...
        <div class="spacer">
            Contenido de Ejemplo para crear altura y permitir el scroll.
        </div>
        <div class="main-menu">
