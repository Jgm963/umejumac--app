...
<head>
    ...
    <style>
        ...
        .header-logo img {
            /* Asegúrate de que el archivo 'logo_umejumac_circle.png.png' esté en tu repositorio */
            width: 100%;
            height: 100%;
            object-fit: contain;
        }
...
<body>
    ...
    <main class="container">
        ...
        <div class="seccion-pilares">
            ...
            <details id="consultoria" class="acordeon-item">
                ...
                <div class="acordeon-content">
                    ...
                    <p><strong>[EDITAR AQUÍ]:</strong> Incluye texto detallado sobre el material de capacitación o los informes de gestión realizados. Por ejemplo: "Nuestros módulos de capacitación incluyen Marco Lógico y Planificación Estratégica aplicados al sector salud."</p>
                    ...
                    <h3>Galería de Reuniones y Resultados</h3>
                    <div class="gallery">
            ...
            <details id="servicios" class="acordeon-item">
                ...
                <div class="acordeon-content">
                    ...
                    <p><strong>[EDITAR AQUÍ]:</strong> Detalla aquí los servicios específicos que ofrece la firma (asesoría legal, desarrollo web, implementación de ERP/CRM, etc.).</p>
                    ...
                    <h3>Portafolio de Proyectos Recientes</h3>
                    <div class="gallery">
        ...
        <section id="ventas">
            ...
            <p>Vehículos, Inmuebles, Libros, Material Médico y más. ¡Contáctanos para más detalles!</p>

            <div class="product-grid">

                <div class="product-item">
                    <img src="ruta/a/tu/vehiculo.jpg" alt="Vehículo Sedán Familiar" class="product-image">
                    <div class="product-details">
                        <h3>Vehículo Sedán Familiar 2020</h3>
                        <p>Motor 2.0L, automático, 120.000 km. Mantenimiento al día. Sensores de aparcamiento y pantalla táctil.</p>
                        <span class="product-price">Precio: $8,500 USD</span>
                    </div>
                </div>
                <div class="product-item">
                    <img src="ruta/a/tu/inmueble.jpg" alt="Apartamento en Venta" class="product-image">
                    <div class="product-details">
                        <h3>Apartamento Céntrico - 3 Habitaciones</h3>
                        <p>120 m², 2 baños, cocina integral, balcón con vista a la ciudad. Cerca de comercios y transporte público.</p>
                        <span class="product-price">Precio: $55,000 USD</span>
                    </div>
                </div>
                <div class="product-item">
                    <img src="ruta/a/tu/libro.jpg" alt="Libro de Medicina" class="product-image">
                    <div class="product-details">
                        <h3>Atlas de Anatomía Humana (Última Edición)</h3>
                        <p>Tapa dura, ilustraciones a color de alta resolución. Nuevo, ideal para estudiantes de ciencias de la salud.</p>
                        <span class="product-price">Precio: $75 USD</span>
                    </div>
                </div>
                </div>
        </section>
