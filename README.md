...
<body class="bg-gray-100 min-h-screen">
    ...
    <header class="header-nav p-4">
        ...
        <!-- NOTA: Se eliminó el div #system-status y #user-info de aquí. -->
    </header>
    ...
    <script type="module">
        ...
        // Se eliminaron las referencias a USER_INFO_ELEMENT y SYSTEM_STATUS_ELEMENT
        ...
        // Se eliminó la función updateSystemStatus
        ...
        const initializeFirebase = async () => {
            ...
            try {
                ...
                // Se eliminó la actualización de estado de carga
                ...
                onAuthStateChanged(auth, (user) => {
                    if (user) {
                        ...
                        // Se eliminó la actualización de estado
                        listenForProducts();
                        ...
                        // Si la autenticación falla, carga estáticos como fallback
                        isStaticMode = true;
                        loadStaticProducts();
                    }
                });
                ...
                // Si la conexión o inicialización fallan, forzar modo estático
                isStaticMode = true; 
                userId = 'ERROR_AUTH';
                isAuthReady = false;
                SAVE_BUTTON.disabled = true;
                // Se eliminó la actualización de estado de error
                loadStaticProducts();
            }
        };
        ...
        const loadStaticProducts = () => {
            ...
            STATIC_PRODUCTS.forEach(product => {
             ...
             PRODUCTS_CONTAINER.innerHTML += '<p class="text-center text-orange-600 col-span-full mt-4 p-4 border border-orange-200 rounded-lg bg-orange-50">Esta es una **Galería Estática** para visualización. El botón de Agregar está deshabilitado.</p>';
        };
        ...
        const renderProduct = (product) => {
            ...
            let coverContent = `
                <img 
                    ...
                    onerror="this.onerror=null; this.src='${DEFAULT_IMAGE_URL}'; this.outerHTML='<div class=\\"cover-placeholder placeholder-img rounded-t-xl\\"><span>FALLO: ${product.title || 'IMAGEN N/A'}</span></div>';"
                />
            `;
            ...
            card.innerHTML = `
                ...
                <div class="p-4 flex flex-col flex-grow">
                    ...
                    <!-- Información de Creación/Propiedad (Solo en modo dinámico - opcional) -->
                    <!-- NOTA: Se eliminó la muestra del UserID completo de la interfaz, pero la data sigue en Firestore. -->
        ...
        const showForm = () => {
            // Validación CRÍTICA: Impedir la apertura en modo estático
        ...
        const startEdit = (product) => {
            ...
            // Asegura que el precio tenga formato de dos decimales
        ...
        const deleteProduct = async () => {
            ...
            try {
                ...
                // NOTA: No usamos alert(), si falla mostramos un mensaje en la consola.
            } finally {
