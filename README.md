...
<head>
    ...
    <style>
        ...
        body {
            ...
            color: #333;
            /* Se mantiene, pero la función JS será la principal */
...
<body>
    ...
    <header class="header-umejumac">
        <h1>UMEJUMAC</h1>
        <a href="#about-logo" onclick="scrollToLogo(event)" class="logo-button" aria-label="Ver detalles del logo UMEJUMAC">
    ...
    <script>
        function scrollToLogo(event) {
            // Previene el comportamiento de ancla predeterminado (salto instantáneo)
            event.preventDefault(); 
            
            // Obtiene el elemento de destino (#about-logo)
            const targetElement = document.getElementById('about-logo');

            if (targetElement) {
                // Utiliza la función scrollIntoView para desplazar la página
