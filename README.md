    ...
    <header class="bg-venezuelan-primary text-white p-4 shadow-md sticky top-0 z-50">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <nav class="hidden md:flex space-x-6 text-lg">
                ...
                <a href="http://umejumac.blogspot.com/" class="hover:text-venezuelan-secondary transition-colors duration-300" target="_blank">Nuestro Blog</a>
            ...
            <div class="md:hidden">
                ...
                <div id="mobile-menu" class="hidden absolute top-16 right-4 bg-venezuelan-primary rounded-lg shadow-xl py-2 w-48 text-right">
                    ...
                    <a href="http://umejumac.blogspot.com/" class="block px-4 py-2 hover:bg-venezuelan-secondary" target="_blank">Nuestro Blog</a>
